 ...
 * 
 * ⚠️ DEPRECATED - НЕ ИСПОЛЬЗУЙТЕ В НОВОМ КОДЕ!
 * 
 * Эти функции сохранены только для обратной совместимости.
 * В новом коде используйте методы класса Debug напрямую:
 * 
 ...
 * - Явность кода (понятно, откуда вызывается метод)
 * - Улучшенная статическая типизация
 * 
 * См. docs/DeprecatedHelpers.md для деталей миграции.
 */
